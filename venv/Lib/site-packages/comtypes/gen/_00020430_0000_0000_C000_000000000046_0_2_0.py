...
__all__ = [ 'OLE_COLOR', 'IFontEventsDisp', 'VgaColor',
           'OLE_XSIZE_HIMETRIC', 'IPictureDisp',
           'OLE_ENABLEDEFAULTBOOL', 'FONTITALIC', 'Font',
           'OLE_YSIZE_CONTAINER', 'OLE_XPOS_PIXELS', 'OLE_CANCELBOOL',
           'FONTBOLD', 'Checked', 'Gray', 'OLE_OPTEXCLUSIVE',
           'Default', 'IFont', 'IFontDisp', 'OLE_YSIZE_HIMETRIC',
           'IPicture', 'Color', 'OLE_YPOS_CONTAINER', 'FONTSIZE',
           'FONTNAME', 'OLE_XPOS_HIMETRIC', 'OLE_XSIZE_PIXELS',
           'OLE_XPOS_CONTAINER', 'FontEvents', 'OLE_YSIZE_PIXELS',
           'OLE_TRISTATE', 'FONTUNDERSCORE', 'FONTSTRIKETHROUGH',
           'LoadPictureConstants', 'OLE_YPOS_PIXELS', 'Unchecked',
           'Monochrome', 'StdPicture', 'OLE_HANDLE',
           'OLE_XSIZE_CONTAINER', 'Picture', 'OLE_YPOS_HIMETRIC',
           'StdFont']
from comtypes import _check_version; _check_version('1.1.11', 1446189471.2686043)
